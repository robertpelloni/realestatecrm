...
export default function AddLeadModal({ addLeadAction, workspaces }: { addLeadAction: (formData: FormData) => Promise<{ error?: string } | void>, workspaces: { id: string, name: string }[] }) {
